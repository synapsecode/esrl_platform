...
VIDEO_TTS_MAX_CONCURRENCY="${VIDEO_TTS_MAX_CONCURRENCY:-7}"
VIDEO_RENDER_MAX_CONCURRENCY="${VIDEO_RENDER_MAX_CONCURRENCY:-7}"
VIDEO_FFMPEG_MAX_CONCURRENCY="${VIDEO_FFMPEG_MAX_CONCURRENCY:-4}"
UPLOAD_IMAGE_MAX_CONCURRENCY="${UPLOAD_IMAGE_MAX_CONCURRENCY:-4}"
...
tell application "Terminal"
    ...
    do script "cd $BASE/esrlBackend && source venv/bin/activate && export GAME_ENGINE_API_URL=$GAME_ENGINE_URL && export VIDEO_TTS_MAX_CONCURRENCY=$VIDEO_TTS_MAX_CONCURRENCY && export VIDEO_RENDER_MAX_CONCURRENCY=$VIDEO_RENDER_MAX_CONCURRENCY && export VIDEO_FFMPEG_MAX_CONCURRENCY=$VIDEO_FFMPEG_MAX_CONCURRENCY && export UPLOAD_IMAGE_MAX_CONCURRENCY=$UPLOAD_IMAGE_MAX_CONCURRENCY && python3 -m uvicorn main:app --host 0.0.0.0 --port 5140 --reload" in front window
